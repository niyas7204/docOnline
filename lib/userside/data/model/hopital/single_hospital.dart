...
//
//     final singleHospital = singleHospitalFromJson(jsonString);

import 'dart:convert';

SingleHospital singleHospitalFromJson(str) => SingleHospital.fromJson(str);

String singleHospitalToJson(SingleHospital data) => json.encode(data.toJson());
...
class SingleHospital {
  ...
  factory SingleHospital.fromJson(Map<String, dynamic> json) => SingleHospital(
        err: json["err"],
