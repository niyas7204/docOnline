...
//
//     final userBookingsModel = userBookingsModelFromJson(jsonString);

import 'dart:convert';

UserBookingsModel userBookingsModelFromJson(Map<String, dynamic> str) =>
    UserBookingsModel.fromJson(str);

String userBookingsModelToJson(UserBookingsModel data) =>
